...
/////////////////////////////////////////////////////////////////////////////////////////////
  ...
  for(int i=0; i<6; i++)
  {
    verts[i].color.bcolor[0]=(byte)std::min(255.0f,vTerrainColor[0]*512.0f);
    verts[i].color.bcolor[1]=(byte)std::min(255.0f,vTerrainColor[1]*512.0f);
    verts[i].color.bcolor[2]=(byte)std::min(255.0f,vTerrainColor[2]*512.0f);
  ...
  for( int i=0; i<m_arrlistBeachVerts[group].Count()-1; i++)
  {
    ...
    BeachPairStruct * p2 = &m_arrlistBeachVerts[group][i+1];
		...
		uchar r1 = (byte)(std::min(255.0f,vTerrainColor[0]*512.0f)*fBrR);
		uchar g1 = (byte)(std::min(255.0f,vTerrainColor[1]*512.0f)*fBrG);
		uchar b1 = (byte)(std::min(255.0f,vTerrainColor[2]*512.0f)*fBrB);
		...
		uchar r2 = (byte)(std::min(255.0f,vTerrainColor[0]*512.0f)*fBrR);
		uchar g2 = (byte)(std::min(255.0f,vTerrainColor[1]*512.0f)*fBrG);
		uchar b2 = (byte)(std::min(255.0f,vTerrainColor[2]*512.0f)*fBrB);
