...
public:
	...
	CInput()
	{
		...
		m_pSystem = NULL;
		m_pLog=NULL;
#if !defined(_XBOX) && !defined(PS2) && !defined(VITA)
		m_g_pdi = NULL;
#endif
	}
...
#endif // !_XBOX && !VITA
#if defined(VITA)
	// VITA: no DirectInput/mouse/keyboard — all stubs
	void AddEventListener( IInputEventListener *pListener );
	void RemoveEventListener( IInputEventListener *pListener );
	void EnableEventPosting ( bool bEnable );
	void PostInputEvent( const SInputEvent &event );
	...
	IInputEventListener *GetExclusiveListener();
	int GetModifiers() const;
	inline void SetMouseExclusive(bool, void* = 0) {}
	inline void SetKeyboardExclusive(bool, void* = 0) {}
	inline bool KeyDown(int) { return false; }
	inline bool KeyPressed(int) { return false; }
	inline bool KeyReleased(int) { return false; }
	inline bool MouseDown(int) { return false; }
	inline bool MousePressed(int) { return false; }
	inline bool MouseDblClick(int) { return false; }
	inline bool MouseReleased(int) { return false; }
	inline float MouseGetDeltaX() { return 0; }
	inline float MouseGetDeltaY() { return 0; }
	inline float MouseGetDeltaZ() { return 0; }
	inline float MouseGetVScreenX() { return 0; }
	inline float MouseGetVScreenY() { return 0; }
	inline void SetMouseInertia(float) {}
	inline bool JoyButtonPressed(int) { return false; }
	inline int JoyGetDir() { return 0; }
	inline int JoyGetHatDir() { return 0; }
	inline Vec3 JoyGetAnalog1Dir(unsigned int) const { return Vec3(0,0,0); }
	inline Vec3 JoyGetAnalog2Dir(unsigned int) const { return Vec3(0,0,0); }
	inline int GetKeyPressedCode() { return 0; }
	inline const char* GetKeyPressedName() { return ""; }
	inline int GetKeyDownCode() { return 0; }
	inline const char* GetKeyDownName() { return ""; }
	inline void WaitForKey() {}
	inline unsigned char GetKeyState(int) { return 0; }
	inline IKeyboard* GetIKeyboard() { return 0; }
