...
#if defined(VITA)
// PS Vita: limited to 350MB total; use small pools with streaming
#define GLOBALPOOLSIZE (4*1024*1024+16)
#define EXTRAPOOLSIZE  (4*1024*1024+16)
#elif !defined(_XBOX)
#define GLOBALPOOLSIZE (32*1025*1025+16)
#define EXTRAPOOLSIZE (32*1025*1025+16)
#else // _XBOX
#ifndef _DEBUG
